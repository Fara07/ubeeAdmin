<template>
  <div class="p-4">
    ...
    >
      <h3 style="color: #212529">Список записей</h3>
    </div>
    ...
    async loadAppointments() {
      try {
        ...
        const response = await this.$axios.get(
          `Administrator/AppointmentGetAllAsync?pageNumber=${this.appointmentResponse.pageNumber}&pageSize=${this.appointmentResponse.pageSize}`
        );
